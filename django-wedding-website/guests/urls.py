...
from guests.views import GuestListView, test_email, save_the_date_preview, save_the_date_random, export_guests, \
    invitation, invitation_email_preview, invitation_email_test, rsvp_confirm, dashboard, invitation_preview
...
urlpatterns = [
    ...
    url(r'^invitation/(?P<template_id>[\w-]+)/(?P<name>[\w-]+)/$', invitation_preview, name='invitation-preview'),
